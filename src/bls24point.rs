...
impl<PAR: BLS24Param, const LIMBS: usize> BLS24Point<PAR, LIMBS> {
    ...
    pub(crate) fn normalize(&self) -> Self {
        ...
        Self {
            x: self.x*inv,
            y: self.y*inv,
            z: BLS24Fp::one().ct_select(&BLS24Fp::zero(), ch),
        }
    }
...
impl<PAR: BLS24Param, const LIMBS: usize> CtAssign for BLS24Point<PAR, LIMBS> {
    #[inline]
...
impl<PAR: BLS24Param, const LIMBS: usize> CtEq for BLS24Point<PAR, LIMBS> {
    #[inline]
...
impl<PAR: BLS24Param, const LIMBS: usize> CtSelect for BLS24Point<PAR, LIMBS> {
    #[inline]
...
impl<PAR: BLS24Param, const LIMBS: usize> Random for BLS24Point<PAR, LIMBS> {
    ...
    fn try_random_from_rng<R: TryRng + ?Sized>(rng: &mut R) -> Result<Self, R::Error> {
        match BLS24Fp::try_random_from_rng(rng) {
    ...
    fn random_from_rng<R: Rng + ?Sized>(rng: &mut R) -> Self {
        Self::point_factory(BLS24Fp::random_from_rng(rng))
    }
}
...
mod tests {
    ...
    fn BLS24Point_test<PAR: BLS24Param, const LIMBS: usize>() {
        ...
        for _t in 0..TESTS {
            ...
            // hashing to G_1:
            let P1: BLS24Point<PAR, LIMBS> = BLS24Point::point_factory(BLS24Fp::random_from_rng(&mut rng)).elim_cof();
            //println!("P1 = {}", P1);
            let P2: BLS24Point<PAR, LIMBS> = BLS24Point::point_factory(BLS24Fp::random_from_rng(&mut rng)).elim_cof();
            //println!("P2 = {}", P2);
            let P3: BLS24Point<PAR, LIMBS> = BLS24Point::point_factory(BLS24Fp::random_from_rng(&mut rng)).elim_cof();
            //println!("P3 = {}", P3);
